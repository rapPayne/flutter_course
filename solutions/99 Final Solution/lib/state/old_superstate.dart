...
class SuperStateWidget extends StatefulWidget {
  ...
  SuperStateWidget({super.key, required this.child, required this.state}) {
...
class SuperState extends ChangeNotifier {
  ...
  static SuperState create({required dynamic state}) {
    ...
    SuperState.singletonInstance = SuperState._(state: state);
  ...
  SuperState._({required this.state});
